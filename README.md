...
<img src="https://skillicons.dev/icons?i=py,java,js,ts,c,react,postgres,mysql,mongodb,spring,django,html,css,sass,git,linux,gcp,docker,kubernetes,selenium,shell,express,nodejs,androidstudio,firebase,figma,vscode" alt="skillss">
</div>
